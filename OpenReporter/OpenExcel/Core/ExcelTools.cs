...
namespace Utilities
{
    public class ExcelTools
    {
        ...
        public static void AddImage(WorksheetPart worksheetPart,
                                    byte[] Buffer, string imgDesc,
                                    int colNumber, int rowNumber,
                                    int SetWidth = 150, int SetHeight = 100)
        {
            ...
            var extentsCx = bm.Width * (long)(914400 / bm.Metadata.HorizontalResolution);
            var extentsCy = bm.Height * (long)(914400 / bm.Metadata.VerticalResolution);
